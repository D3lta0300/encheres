...
public class Entrer_Objet extends VerticalLayout {
    ...
    Entrer_Objet(VuePrincipale main) {
        ...
        Description.setHeight(20, Unit.PERCENTAGE);
        this.send = new Button("Valider");
        add(upload, output, send, Titre, Description);
